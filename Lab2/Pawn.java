// Nichole Maldonado
// CS331 - Lab 2, Pawn Class

/*
 * This class file contains the Pawn class which stores the
 * x and y Position of a Pawn on the chess board and whether
 * a Pawn is black or white. It also includes the method
 * validateMove which determines if the Pawn can reach the 
 * coordinate.
 */
...
/*
 * Class Pawn that stores the x position on the chess board,
...
public class Pawn {
    ...
    /*
     * Default constructor for Pawn. Initializes the xPosition and yPosition
    ...
    /*
     * Constructor for Pawn class that initializes the attributes
     * xPosition, yPosition, and whether the pawn is white or black.
     * @param: the name, xPosition, yPosition, and isWhite values that
     *         will be assigned to the fields.
     * @return: None.
     */
    public Pawn(char xPosition, int yPosition, boolean isWhite, String type){
    ...
    /*
     * Method that verfies if a pawn ChessPiece can move to coordinate.
     * @param: The coordinate that will be tested to detmine if the pawn
    ...
    public boolean validateMove(Coordinates position) {
        ...
        if (this.isWhite) {
            return position.canReachVertically(this.xPosition, this.yPosition + 1, 
                this.yPosition + 1);
        }
