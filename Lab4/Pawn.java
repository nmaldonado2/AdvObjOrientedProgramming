...
public class Pawn extends ChessPiece {
    public static final int WHITE_INITIAL_START = 2;
    public static final int BLACK_INITIAL_START = 7;
     ...
     * @return: None.
     */
    public Pawn(char xPosition, boolean isWhite){
        super("Pawn", xPosition, WHITE_INITIAL_START, isWhite);
        
        if (!isWhite) {
            this.setYPosition(BLACK_INITIAL_START);
            this.setName("Pawn" + xPosition + BLACK_INITIAL_START);
        }
    }
    ...
    public boolean validMove(char xPosition, int yPosition) {
        ...
        return (this.getIsWhite() && yPosition - this.getYPosition() <= moveAmount && 
